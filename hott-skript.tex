...
\begin{bemerkung}
  ...
  \begin{enumerate}
  \item Wenn $f$ eine beidseitige Inverse hat, dann ist $f$ eine Äquivalenz. Das heißt es gibt eine Funktion:
    \begin{mathpar}
      \qinv(f)\to \isEquiv(f)
    \end{mathpar}
  \item Wenn $f$ surjektiv und injektiv ist, dann ist $f$ eine Äquivalenz.
  \end{enumerate}
\end{bemerkung}
