...
Ein Beispiel dafür ist die folgende wichtige Definition, die uns von nun an begleiten wird:
\begin{definition}
  Seien $A,B$ Typen. Zwei Funktionen $f:A\to B$ und $g:B\to A$ sind \begriff{zueinander invers},
  wenn
  \begin{mathpar}
...
\end{definition}
Wir werden später das sogenannte \begriff{Univalenzaxiom} einführen, aus dem gefolgert werden kann, dass punktweise Gleichheiten bereits die Gleichheit von Funktionen zur Folge hat.
