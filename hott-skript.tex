...
\begin{definition}
  ...
  \item $f$ ist eine \begriff{Äquivalenz} oder eine Funktion mit \begriff{Links- und Rechtsinversen}, wenn
    \begin{mathpar}
      \isEquiv(f):\equiv\mathrm{LRInv}(f):\equiv \left(\sum_{g:B\to A}f\circ g\sim\id_B\right)\times \left(\sum_{h:B\to A}h\circ f\sim\id_A\right)
    \end{mathpar}
...
\end{bemerkung}
\begin{beweis}
  Nehmen wir zünachst an, es gibt eine Quasi-Inverse $g:B\to A$ mit $H:f\circ g\sim\id_B$ und $K:g\circ f\sim\id_A$. Dann ist
  \begin{mathpar}
