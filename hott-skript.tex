...
\begin{definition}
  ...
  \begin{mathpar}
    \mathrm{ind}_{\N}(n:\N\yields A,f_0,f_s):\equiv\mathrm{rec}_{\N}(A,f_0,f_s):\N\to A
  \end{mathpar}
...
\begin{beispiel}
  ...
  \begin{mathpar}
    d:\equiv \mathrm{rec}_{\N}(\N, 0, n \mapsto (k \mapsto \mathrm{succ}(\mathrm{succ}(k))))
  \end{mathpar}
...
Dazu brauchen wir die folgenden $\beta$-Regeln -- die nichts anderes sagen, als dass eine durch Induktion definierte Funktion die durch Induktionsanfang und Schritt gegebenen Werte auch annimmt:
