...
\end{lemma}
\begin{beweis}
  Wegen $(y,\refl_y):\Sigma_{x:A}x=y$ reicht es zu zeigen, dass der Typ eine Aussage ist, also je zwei Elemente gleich sind.
  Durch $\Sigma$-Induktion, reicht es zu zeigen, dass je zwei paare
  \begin{mathpar}
    (x,q),(x',q'):\Sigma_{x:A}x=y
  \end{mathpar}
  gleich sind. Es ist $q\kon q'^{-1}:x=x'$ und damit können wir $\Sigma_=$ verwenden:
  \begin{mathpar}
