...
\begin{definition}
  Es sei eine faserweise Abbildung 
  \begin{mathpar}
    \Eq{S^1}(\ast,\_):\prod_{x:S^1}\ast=_{\tilde{S^1}}x\to \tilde{S^1}(x)
  \end{mathpar}
  durch:
  \begin{align*}
    \Eq{S^1}(\ast,\ast)&\colonequiv w : \ast=\ast\to\Z \\
    \mathrm{apd}(\Eq{S^1}(\ast,\_),l)&:=\text{ Die Gleichheit aus \cref{bem:hom-windungszahl}}
  \end{align*}
\end{definition}
