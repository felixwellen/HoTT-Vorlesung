...
\begin{bemerkung}
  $A / R$ ist stets eine Menge.
\end{bemerkung}
\begin{beweis}
  Das wird durch den dritten Konstruktor direkt so erzwungen.
\end{beweis}
...
\begin{definition}
  ...
  \end{mathpar}
  Die \begriff{Ganzen Zahlen}\index{$\Z$} sind wie folgt als Quotient gegeben:
  \begin{mathpar}
