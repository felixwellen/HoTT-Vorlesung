...
\begin{lemma}
  Sei $n\geq -1$. Ein punktierter Typ $A$ ist genau dann ein $n$-Typ, wenn für alle $x:A$ der Typ $\Omega^{n+1}(A,x)$ kontrahierbar ist.
\end{lemma}
\begin{beweis}
...
\begin{theorem}
  Sei $f:A\to^{\ast}B$ eine punktierte Abbildung. Dann gibt es eine lange exakte Sequenz:
  \begin{center}
    \begin{tikzcd}
      \dots\ar[r] & \pi_{n+1}(F)\ar[r] & \pi_{n+1}(A)\ar[r,"\pi_{n+1}(f)"] & \pi_{n+1}(B)\ar[r] & \pi_n(F)\ar[r] & \pi_n(A)\ar[r,"\pi_n(f)"] & \pi_n(B)\ar[r] & \dots
    \end{tikzcd}
  \end{center}
  Die bei $n=0$ mit 
\end{theorem}
