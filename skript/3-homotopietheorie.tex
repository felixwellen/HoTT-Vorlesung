...
\begin{bemerkung}
  ...
  \item Wenn $f$ punktiert ist, dann ist die Faser von $f$ wie folgt ein Pullback:
    \begin{center}
      ...
      \end{tikzcd}
    \end{center}
  \item Die Begriffe Quadrat und Pullbackquadrat sind invariant unter ersetzen von Typen mit äquivalenten Typen und ersetzen von Abbildungen durch homotope Abbildungen.
  \end{enumerate}
\end{bemerkung}
